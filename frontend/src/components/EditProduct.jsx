                ...
                <form onSubmit={updateProduct} className="my-10">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mb-5">
                            ...
                            <input type="text" className="w-full py-3 mt-1 border border-slate-200 rounded-lg px-3 focus:outline-none focus:border-slate-500 hover:shadow" placeholder="Price"
                            value={price}
